...
public class SpectrumView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        mSpace = a.getDimensionPixelSize(R.styleable.AudioSpectruView_RectangularBarSpace, ScreenUtil.Companion.dp2px(3));
        mWidth = a.getDimensionPixelSize(R.styleable.AudioSpectruView_RectangularBarWidth, ScreenUtil.Companion.dp2px(2));
        mRadius = a.getDimensionPixelSize(R.styleable.AudioSpectruView_RectangularBarRadius, ScreenUtil.Companion.dp2px(8));
        mMinHeight = a.getDimensionPixelSize(R.styleable.AudioSpectruView_RectangularBarMinHeight, ScreenUtil.Companion.dp2px(8));
        a.recycle();
        initPaint();
    }
    ...
    private int measureHeight(int measureSpec) {
        ...
        if (mode == MeasureSpec.EXACTLY) {
            ...
            //默认高度100dp
            mGroupHeight = getPaddingTop() + ScreenUtil.Companion.dp2px(100) + getPaddingBottom();
