...
import com.lskj.gx.basic_widget.GxRoundImgView;
...
public class GxRoundDelImageView extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        @SuppressLint("CustomViewStyleable") TypedArray a =
                mContext.obtainStyledAttributes(attrs, com.lskj.gx.basic_widget.R.styleable.GxRoundImgView);
        realHeight = a.getDimensionPixelSize(com.lskj.gx.basic_widget.R.styleable.GxRoundWithDelete_real_height, realHeight);
        realWidth = a.getDimensionPixelSize(com.lskj.gx.basic_widget.R.styleable.GxRoundWithDelete_real_width, realWidth);
        delHeight = a.getDimensionPixelSize(com.lskj.gx.basic_widget.R.styleable.GxRoundWithDelete_del_height, delHeight);
        delWidth = a.getDimensionPixelSize(com.lskj.gx.basic_widget.R.styleable.GxRoundWithDelete_del_width, delWidth);
        a.recycle();
        if (imgEntity != null) {
            drawImg();
        }
    ...
    private void drawImg() {
        ...
        realImage.setId(com.lskj.gx.basic_widget.R.id.round_with_delete_real_image);
        ...
        if (drawRealImageListener != null) {
            ...
            //默认处理
            Glide.with(mContext).load(imgEntity.getCover()).into(realImage);
        }
        ...
        delImage.setId(com.lskj.gx.basic_widget.R.id.round_with_delete_del_image);
        ...
        delImage.setImageDrawable(getResources().getDrawable(com.lskj.gx.basic_widget.R.drawable.default_delete_icon));
