    ...
    private GxRoundDelImageView.onDrawRealImageListener onDrawRealImageListener =
            (gxImgView, entity) -> {
                ...
                if (ADD_FLAG.equals(entity.getPid())) {
                    Glide.with(mContext).load(entity.getCover()).into(gxImgView);
...
//                    gxImgView.setImageDrawable(getResources().getDrawable(Integer.parseInt(entity.getUrl())));
    ...
    public void init(Context context, AttributeSet attrs) {
        ...
        addBtn = new BaseImageEntity(UUID.randomUUID().toString(), ADD_FLAG, com.lskj.gx.basic_widget.R.drawable.add_photo, com.lskj.gx.basic_widget.R.drawable.add_photo, "png", -1);
        //添加按钮
        if (isEditModel) {
            addbtnView();
        }
    ...
    private ImageView createSpace() {
        ...
        if (bg == null) {
            bg = getResources().getDrawable(com.lskj.gx.basic_widget.R.drawable.white_space);
        }
